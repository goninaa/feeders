...
class Data:
    ...
    def plot_pref (self, minutes = '10Min', name= 'choices_only', events = False): #changed
        ...
        if events == False: 
            ...
            df_mean_pref = self.stay_prob_ev.resample(minutes, base = self.base, label='right').mean()
...
if __name__ == "__main__":
    ...
    fname = '/Users/gonina/Library/Mobile Documents/com~apple~CloudDocs/lab/python_codes/feeders/feeders analysis/2020-03-30-06_A_Tzadi_slow.csv'
